...
export default function Projects() {
  ...
  return <section className="section projects light" id="projects"><div className="shell">
    <div className="section-heading reveal"><div><div className="section-kicker"><span>03</span> Selected systems</div><h2 className="section-title">Real work.<br /><em>Real impact.</em></h2></div><p>Nine full-stack, frontend, and algorithmic products across healthcare, commerce, finance, property, messaging, and games.</p></div>
