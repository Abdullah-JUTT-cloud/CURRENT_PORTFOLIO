      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            Combining software engineering fundamentals, modern frontend tooling, and robust backend systems to create scalable and impactful digital experiences.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard
            ...
            text="Strong fundamentals in DSA, OOP, systems design, and database design — writing clean, maintainable code with C++, Java, JavaScript, and TypeScript."
          ...
          <TagCard
            ...
            text="Crafting responsive, high-performance interfaces with React, Next.js, TypeScript, Tailwind CSS, Framer Motion, GSAP, and React Native."
          ...
          <TagCard
            ...
            text="Building robust RESTful APIs and scalable backends with Spring Boot, Node.js, Express, MongoDB, PostgreSQL, Redis, and SQL." 
          ...
          <TagCard
            ...
            text="Architecting complete products from database schema to polished UI — MERN platforms, real-time apps, and SaaS solutions built to scale and dominate in production."
